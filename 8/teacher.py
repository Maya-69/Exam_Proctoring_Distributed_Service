...
def run_teacher():
    ...
    with SimpleXMLRPCServer(("0.0.0.0", 9001),
        ...
        print(f"[{get_formatted_time()}] [TEACHER] - Enhanced Marksheet: print_results (Traditional + Task 6 + Task 7 + Task 8)")
        ...
        print(f"[{get_formatted_time()}] [TEACHER] - TASK 8 NEW: initialize_replication_system, show_replication_status, write_to_marksheet_replicas")
        print(f"[{get_formatted_time()}] [TEACHER] Ready to handle requests with full replication support...")
